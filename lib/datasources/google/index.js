...
function parse(data) {
    ...
    const countryData = getFirstCountryData(postalCodeData.address_components);
    const provinceData = getFirstProvinceData(postalCodeData.address_components);
    const cityOrRegencyData = getFirstCityOrRegencyData(postalCodeData.address_components);
    const districtData = getFirstDistrictData(postalCodeData.address_components);
